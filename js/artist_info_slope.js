...
export function artistinfo(data, map, options) {
  ...
  const img_container = div.append("div").classed("img_container", true);

  const text_container = div.append("div").classed("text_container", true);

  const title_div = text_container.append("div").classed("title", true);

  const location_div = text_container.append("div").classed("location", true);
  ...
  function update(newData = data, newMap = map, newOptions = options) {
    ...
    img.data(data).attr("src", (d) => `${d[map.artist_image]}`);

    title.data(data).text((d) => d[map.title]);
